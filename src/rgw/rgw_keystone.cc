...
void
rgw::keystone::TokenEnvelope::AccessRule::decode_json(JSONObj* obj)
{
  // Keystone returns these fields for each access rule in
  // token.application_credential.access_rules array
...
rgw::keystone::TokenEnvelope::decode(JSONObj* const root_obj)
{
  ...
  // This is optional - not all tokens have application credentials.
